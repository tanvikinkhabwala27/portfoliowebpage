...
export default function Home() {
  ...
  return <main>
    ...
    <section className="labBridge"><div className="shell labBridgeInner"><div className="labBridgeCopy"><p className="kicker">Want to go deeper?</p><h2>See how I work<br />with data.</h2><p>The Analytics Lab is an interactive space to explore how I assess messy data, connect multiple sources, and determine what the data can reliably tell us.</p><a className="button" href="/analytics-lab">Explore the Analytics Lab <span>→</span></a></div><ol className="labBridgeSteps" aria-label="Analytics Lab preview"><li><span>01</span><div><strong>Data health</strong><em>Can I trust it?</em></div></li><li><span>02</span><div><strong>Data connections</strong><em>Can these sources work together?</em></div></li><li><span>03</span><div><strong>Analysis readiness</strong><em>What can I learn from it?</em></div></li></ol></div></section>

    <aside className="problemCta"><div className="shell problemCtaInner"><div><p className="kicker">Optional</p><h2>Have a real data problem?</h2></div><div><p>I also work with growing teams on focused analytics problems — from understanding messy data to uncovering opportunities and automating repetitive work.</p><a className="textlink" href={contact}>Let&apos;s talk →</a></div></div></aside>
