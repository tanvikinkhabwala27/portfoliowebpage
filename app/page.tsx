...
const impact = [
  ...
  { stat:'REVENUE ≠', unit:'opportunity · illustrative', title:'Found where the business should focus next', copy:'Combined performance, profitability, and customer behavior to identify a stronger growth opportunity than revenue alone suggested.' },
